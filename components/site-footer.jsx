    ...
    <footer className="bg-slate-900 text-slate-300 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display text-2xl font-bold text-white">Voyagio</span>
            </Link>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          <p>© {new Date().getFullYear()} Voyagio. Toate drepturile rezervate.</p>
          <div className="flex items-center gap-2">
            <Mail className="w-4 h-4" />
            <a href="mailto:hello@voyagio.ro" className="hover:text-cyan-400">hello@voyagio.ro</a>
          </div>
        </div>
      </div>
    </footer>
